                                ...
                                <div id="myTabContent" class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                                        <div class="product-tab1">
                                            @foreach($brandProducts as $brandProduct)
                                                <div class="col-md-4 product-tab1-grid mb-3">
                                                    <div class="grid-arr">
                                                        <div  class="grid-arrival">
                                                            <figure>
                                                                <a href="{{ route('product-details', ['id'=>$brandProduct->id]) }}" class="new-gri" >
                                                ...
                                                <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem mb-3">
                                                    <div class="card card-body col-md-12 text-center">
                                                        ...
                                                        <div class="women">
                                                            <h6><a href="single.html">{{ $brandProduct->product_name }}</a></h6>
                                                            <span class="size">XL / XXL / S </span>
                                                            <p><b class="text-info">{{ $brandProduct->short_description }}</b></p>
